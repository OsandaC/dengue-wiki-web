...
### Brazil 2007 — São Paulo State Outbreak

[[Jardim2012 - Autoimmune Features DHF Case Report]] documents a DENV-3 outbreak in São Paulo state (Brazil), confirmed by the São Paulo State Department of Health, active in May 2007. A 25-year-old woman with secondary dengue (IgM+/IgG+ serology) developed DHF with triple serositis, DIC, ANA 1/320 (mitotic spindle pattern), cryoglobulinemia, and selective C3 depression — all resolving at follow-up. This is the first Brazilian DENV-3 case in this wiki and confirms DENV-3 community transmission in Brazil at that time (n=1 case report — not generalizable as an epidemiological source).

...
- **PAIgM completely bypasses FcγR:** [[Saito2004 - PAIgG and PAIgM in Secondary Dengue]] extends this FcγR-independence further. PAIgM (also elevated in secondary infection; carries anti-dengue IgM specificity) cannot engage any FcγR at all due to the IgM pentamer structure. PAIgM-mediated platelet clearance therefore proceeds exclusively via complement receptor- and complement-mediated lysis. This means the FcγRIIa-HH paradox applies with even greater force to PAIgM: PAIgM is a highly specific DHF predictor (92.1% specificity) yet is mechanistically independent of FcγRIIa genotype. If FcγRIIa affects dengue severity, it must do so entirely through pathways other than platelet-associated immunoglobulin clearance — ADE in monocytes/macrophages is the leading hypothesis.

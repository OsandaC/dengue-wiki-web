...
3. **Severe dengue**: Severe plasma leakage (DSS, fluid accumulation with respiratory distress); severe bleeding; severe organ impairment (liver, CNS, kidneys, heart)
...
- Some concerns: warning signs less useful in adults than children; high sensitivity but limited specificity → increased hospital admissions during epidemics
(see [[Guzman2016 - Dengue Infection]])
